...
class ProductFilterState extends Equatable {
  ...
  ProductFilterState copyWith({
    ...
    return ProductFilterState(
      ...
      selectedLabels: selectedLabels == unchanged
          ? this.selectedLabels
          : selectedLabels as List<Label>?,
      searchQuery:
          searchQuery == unchanged ? this.searchQuery : searchQuery as String?,
      activeLabel:
          activeLabel == unchanged ? this.activeLabel : activeLabel as String,
    );
  }
