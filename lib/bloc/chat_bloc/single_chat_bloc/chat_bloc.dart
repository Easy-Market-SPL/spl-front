...
class ChatBloc extends Bloc<ChatEvent, ChatState> {
  ...
  void _setupMessageSubscription() {
    ...
    _messagesSubscription =
        _chatService.watchChatMessages(_chatId!).listen((updatedData) {
      debugPrint(
          'Received real-time message update with ${updatedData.length} messages');
  ...
  void _onUpdateMessages(UpdateMessagesEvent event, Emitter<ChatState> emit) {
    debugPrint(
        'Updating chat with ${event.messages.length} messages from subscription');
