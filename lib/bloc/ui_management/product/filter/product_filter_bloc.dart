...
class ProductFilterBloc extends Bloc<ProductFilterEvent, ProductFilterState> {
  ...
  void _onApplyFiltersFromDialog(ApplyFiltersFromDialog event, Emitter<ProductFilterState> emit) {
  ...
  void _onSetSearchQuery(SetSearchQuery event, Emitter<ProductFilterState> emit) {
  ...
  void _onChangeLabelFilter(ChangeLabelFilter event, Emitter<ProductFilterState> emit) {
