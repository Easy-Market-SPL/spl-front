...
import 'package:spl_front/widgets/products/cards/business_product_rated_card.dart';

class BusinessProductRatedGrid extends StatelessWidget {
  ...
  BusinessProductRatedGrid({super.key});
  ...
  Widget build(BuildContext context) {
    return GridView.builder(
      ...
      itemBuilder: (context, index) {
        ...
        return BusinessProductRatedCard(
          name: product["name"],
