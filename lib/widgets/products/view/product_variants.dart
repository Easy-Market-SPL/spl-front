...
class _VariantsEditorState extends State<VariantsEditor> {
  ...
  void _addOption(int variantIndex) async {
    ...
    if (optionName != null && optionName.trim().isNotEmpty) {
      setState(() {
        widget.variants[variantIndex].options.add(VariantOption(name: optionName.trim()));
      });
      widget.onVariantsChanged();
    }
  }
              ...
              child: Column(
                ...
                children: [
                  ...
                  Wrap(
                    ...
                    children: [
                      // j = option index
                      for (int j = 0; j < widget.variants[i].options.length; j++)
                        // Option Chip
                        Chip(
                          label: Text(widget.variants[i].options[j].name, style: TextStyle(color: Colors.blue),),
                          backgroundColor: Colors.white,
                      ...
                      ActionChip(
                        ...
                        label: const Text("Agregar Opción", style: TextStyle(color: Colors.white),),
