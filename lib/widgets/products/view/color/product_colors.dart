...
import 'package:spl_front/widgets/products/view/color/product_default_color_dialog.dart';
...
class _ColorPickerWidgetState extends State<ColorPickerWidget> {
  ...
  Future<void> _addNewColor() async {
    ...
    if (newColor != null) {
      ...
      bool duplicate = _colors.any((c) =>
          c.hexCode.toUpperCase() == newColor.hexCode.toUpperCase());
      if (duplicate) {
