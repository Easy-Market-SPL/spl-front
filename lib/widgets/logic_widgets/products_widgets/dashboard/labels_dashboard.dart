            ...
            builder: (context, filterState) {
              ...
              for (var label in nonTodosLabels) {
                bool isSelected = filterState.selectedLabels?.any(
                        (selectedLabel) =>
                            selectedLabel.idLabel == label.idLabel) ??
                    false;
                      ...
                      child: ElevatedButton(
                        onPressed: () {
                          ...
                          context
                              ...
                              .add(ChangeLabelFilter("Todos"));
                        },
                        style: ElevatedButton.styleFrom(
                          backgroundColor:
                              !hasSelectedLabels ? Colors.blue : Colors.white,
                          foregroundColor:
                              !hasSelectedLabels ? Colors.white : Colors.black,
                        ...
                        child: ElevatedButton(
                          onPressed: () {
                            if (isSelected) {
                              ...
                              final newSelectedLabels = filterState
                                  .selectedLabels!
                              ...
                              context.read<ProductFilterBloc>().add(
                                    ApplyFiltersFromDialog(
                                      ...
                                      maxPrice: filterState.maxPrice,
                                      minRating: filterState.minRating,
                                      selectedLabels: newSelectedLabels.isEmpty
                                          ? null
                                          : newSelectedLabels,
                                    ),
                                  );
                              ...
                              if (filterState.selectedLabels != null) {
                                newSelectedLabels =
                                    List.from(filterState.selectedLabels!);
                              }
