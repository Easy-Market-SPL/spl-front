...
class _ProductFilterDialogState extends State<ProductFilterDialog> {
  ...
  void initState() {
    ...
    _maxPriceValue =
        widget.maxProductPrice != null ? widget.maxProductPrice! : 1000000;
          ...
          child: Column(
            ...
            children: [
              ...
              Row(
                mainAxisAlignment: MainAxisAlignment.spaceBetween,
                children: [
                  Text(PriceFormatter.formatPrice(_priceRange.start,
                      withDecimal: false)),
                  Text(PriceFormatter.formatPrice(_priceRange.end,
                      withDecimal: false)),
                ],
              ),
                  ...
                  if (state is LabelLoading) {
                    ...
                    return Wrap(
                      ...
                      children: labels.map((label) {
                        final isSelected = _selectedLabels
                            .any((l) => l.idLabel == label.idLabel);
                        return FilterChip(
                  ...
                  ElevatedButton(
                    onPressed: () {
                      final filter = ProductFilter(
                        ...
                        selectedLabels:
                            _selectedLabels.isEmpty ? null : _selectedLabels,
                      );
