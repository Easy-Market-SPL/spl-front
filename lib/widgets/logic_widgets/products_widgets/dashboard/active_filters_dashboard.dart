      ...
      builder: (context, state) {
        ...
        if (state.minPrice != null) {
          chips.add(
            Chip(
              label: Text(
                  '${DashboardStrings.fromPriceWithValue} ${PriceFormatter.formatPrice(state.minPrice!)}'),
              onDeleted: () => context
                  .read<ProductFilterBloc>()
                  .add(RemoveFilter(ProductFilterType.minPrice)),
        ...
        if (state.maxPrice != null) {
          chips.add(
            Chip(
              label: Text(
                  '${DashboardStrings.toPriceWithValue} ${PriceFormatter.formatPrice(state.maxPrice!)}'),
              onDeleted: () => context
                  .read<ProductFilterBloc>()
                  .add(RemoveFilter(ProductFilterType.maxPrice)),
              deleteIcon: const Icon(Icons.close, size: 18),
            ),
          );
        }
          ...
          chips.add(
            Chip(
              label: Row(
                ...
                children: [
                  Text(
                      '${DashboardStrings.minRatingWithValue} ${state.minRating!.toStringAsFixed(1)}'),
              ...
              onDeleted: () => context
                  .read<ProductFilterBloc>()
                  .add(RemoveFilter(ProductFilterType.minRating)),
              deleteIcon: const Icon(Icons.close, size: 18),
            ),
          );
        }
        ...
        if (chips.isNotEmpty) {
          chips.add(
            ActionChip(
              ...
              onPressed: () =>
                  context.read<ProductFilterBloc>().add(ClearFilters()),
